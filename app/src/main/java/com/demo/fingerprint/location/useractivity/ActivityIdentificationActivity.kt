...
*/
package com.demo.fingerprint.location.useractivity
...
import com.demo.fingerprint.R
import com.demo.fingerprint.location.activity.BaseActivity
import com.demo.fingerprint.location.fusedlocation.LocationBroadcastReceiver
import com.demo.fingerprint.location.logger.LocationLog.Companion.e
import com.demo.fingerprint.location.logger.LocationLog.Companion.i
import com.demo.fingerprint.location.utils.RequestPermission.Companion.requestActivityTransitionPermission
import com.demo.fingerprint.location.utils.Utils.ACTION_PROCESS_LOCATION
import com.demo.fingerprint.location.utils.Utils.addIdentificationListener
import com.demo.fingerprint.location.utils.Utils.removeIdentificationListener
