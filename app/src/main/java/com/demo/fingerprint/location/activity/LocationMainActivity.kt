 ...
 */
package com.demo.fingerprint.location.activity
...
import com.demo.fingerprint.location.fusedlocation.*
import com.demo.fingerprint.R
import com.demo.fingerprint.location.geofence.OperateGeoFenceActivity
import com.demo.fingerprint.location.useractivity.ActivityConversionActivity
...
class LocationMainActivity : AppCompatActivity() {
     ...
     * will start
     */
    fun locationTransitionUpdate(view: View) {
        Log.d("click", "ButtonClick  {$view}")
     ...
     * will start
     */
    fun locationActivityUpdate(view: View) {
        Log.d("click", "ButtonClick  {$view}")
